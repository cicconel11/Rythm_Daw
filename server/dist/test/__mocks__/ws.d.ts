...
export declare class MockWebSocket extends EventEmitter implements WebSocket {
    ...
    readyState: number;
    send: jest.Mock<void, [data: string | ArrayBufferLike | ArrayBufferView | Blob], any>;
    close: jest.Mock<void, [code?: number, reason?: string], any>;
    terminate: jest.Mock<void, [], any>;
    pause: jest.Mock<any, any, any>;
    resume: jest.Mock<any, any, any>;
    ping: jest.Mock<void, [cb?: () => void], any>;
    isAlive: boolean;
    on: <K>(eventName: string | symbol, listener: (...args: any[]) => void) => this;
    once: <K>(eventName: string | symbol, listener: (...args: any[]) => void) => this;
    addEventListener: jest.Mock<void, [type: any, listener: (this: WebSocket, ev: any) => any, options?: boolean | AddEventListenerOptions], any>;
    removeEventListener: jest.Mock<void, [type: any, listener: (this: WebSocket, ev: any) => any, options?: boolean | EventListenerOptions], any>;
