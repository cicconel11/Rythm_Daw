...
const mockFriends: Friend[] = [
  { id: '1', name: 'Alex Producer', avatar: '/placeholder.svg', isOnline: true },
  { id: '2', name: 'Sarah Beats', avatar: '/placeholder.svg', isOnline: false },
  { id: '3', name: 'Mike Mixer', avatar: '/placeholder.svg', isOnline: true },
];
...
const UploadCard = () => {
  ...
  const handleDrop = useCallback((e: React.DragEvent) => {
    ...
    // TODO: Process actual file uploads with useUploadFiles hook
  }, []);
  ...
  const handleSendFiles = useCallback(() => {
    ...
    // - Emit file-share events (type, fileMeta, toUserId)
    // - Use optimistic UI to show pending transfers
    // - Clear selection and open TransferProgressModal
