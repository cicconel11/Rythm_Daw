...
import { getDeviceStatus, connectDevice } from '@/lib/dataClient';

export default function DevicePage() {
  usePageMeta(ROUTES.device.name);
  const [connectionCode, setConnectionCode] = useState('');
  const [isGenerating, setIsGenerating] = useState(false);
  const [deviceStatus, setDeviceStatus] = useState<{ connected: boolean; lastSeen?: string } | null>(null);
  ...
  return (
    <>
      <Head>
        <title>Device Connection | Rythm Daw</title>
      </Head>
