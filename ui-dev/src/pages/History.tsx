...
import { Activity, Clock, Filter, Search, User, Download, Trash2 } from 'lucide-react';
...
export default function History() {
  ...
  const filteredActivities = activities.filter((activity) => {
    ...
    const matchesTimeRange = 
      timeRange === 'all' ||
      (timeRange === 'today' && activity.timestamp.includes('minute') || activity.timestamp.includes('hour')) ||
      (timeRange === 'week' && !activity.timestamp.includes('month') && !activity.timestamp.includes('year')) ||
  ...
  const getActivityTypeLabel = (type: ActivityType) => {
    switch (type) {
      case 'file': return 'File Activity';
      case 'plugin': return 'Plugin Activity';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-400">Track all your activities and changes</p>
        </div>
          ...
          <div className="divide-y divide-gray-700">
            {filteredActivities.length > 0 ? (
                    ...
                    <div className="ml-4 flex-1">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-medium text-white">
                          <span className={activity.user === 'You' ? 'text-purple-400' : ''}>
                            {activity.user}
                          </span>{' '}
              ...
              <div className="p-8 text-center">
                ...
                <h3 className="mt-2 text-sm font-medium text-gray-300">No activities found</h3>
