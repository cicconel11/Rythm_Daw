...
export function SettingsAccount({ onUpdateAccount, onAvatarChange, onRescanPlugins }: SettingsAccountProps) {
            ...
            <CardContent>
              <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <Label htmlFor="avatar" className="text-muted-foreground cursor-pointer">
                    ...
                    />
                    <p className="text-xs text-muted-foreground/70 mt-1">Max 2MB, JPG or PNG</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-muted-foreground/70">{bio.length}/140 characters</span>
                    {bio.length > 120 && (
                      <span className="text-xs text-orange-400">Approaching limit</span>
                    )}
                  </div>
                </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-semibold text-foreground">Plugin Library</h3>
                    <p className="text-muted-foreground text-sm">Scan for new and updated plugins</p>
                  </div>
                  <Button
              ...
              <div className="flex items-center justify-between py-3 border-t border-border">
                <div>
                  <Label htmlFor="show-inactive" className="text-muted-foreground font-medium">
                    Show inactive plugins
                  </Label>
                  <p className="text-xs text-muted-foreground/70">Display plugins that are not currently loaded</p>
                </div>
                <Switch
                  id="show-inactive"
